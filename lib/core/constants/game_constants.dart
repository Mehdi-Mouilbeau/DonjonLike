class GameConstants {
  ...
  // Sprite dimensions
  static const int spriteColumns = 4;
  static const int spriteRows = 2;

  // Movement
  static const double playerSpeed = 500.0;
  static const double playerScale = 0.8;
  ...
  // Room layout
  static const double roomSize = 800.0;
  static const double pedestalSize = 150.0;

  // Cat
  static const double catScale = 1.0;
}
